# -*- coding: utf-8 -*-
"""
Created on Mon Jun  5 15:23:29 2023
...
def draw_cat_plot():
    ...
    #df.rename(columns = {'id':'iden'}, inplace = True)
    ...
    #each feature. You will have to rename one of the columns 
